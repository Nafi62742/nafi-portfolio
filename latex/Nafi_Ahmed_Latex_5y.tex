...
\color[HTML]{371e77} \textbf{\normalsize{Software Engineer \textbar\ AI-Assisted Engineering (Claude Specialist)}} \\[3pt]
...
\item \textit{Internship:} Built mobile and backend features using Flutter, Laravel, PHP, and MySQL REST APIs.
\end{itemize}
\end{minipage}
\end{tabularx}
